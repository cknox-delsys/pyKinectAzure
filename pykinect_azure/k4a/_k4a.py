...
class k4a_dll:
    ...
    def setup_library(self, module_k4a_path=None):
        if module_k4a_path is None:
            module_k4a_path = get_k4a_module_path()

        try: 
            self.k4a_dll = ctypes.CDLL(module_k4a_path)

        except Exception as e:
            print("Failed to load library", e)
            sys.exit(1)

    def k4a_device_get_installed_count(self):
        #K4A_EXPORT uint32_t k4a_device_get_installed_count(void);

        return self.k4a_dll.k4a_device_get_installed_count()

    def k4a_device_open(self, device_id, device_handle):
        #K4A_EXPORT k4a_result_t k4a_device_open(uint32_t index, k4a_device_t *device_handle);

        _k4a_device_open = self.k4a_dll.k4a_device_open
    ...
    def k4a_device_get_capture(self, device_handle, capture_handle, timeout):
        ...
        _k4a_device_get_capture = self.k4a_dll.k4a_device_get_capture
    ...
    def k4a_device_get_imu_sample(self, device_handle, imu_sample_handle, timeout):
        """
        ...
        _k4a_device_get_imu_sample = self.k4a_dll.k4a_device_get_imu_sample
    ...
    def k4a_capture_create(self, capture_handle):
        #K4A_EXPORT k4a_result_t k4a_capture_create(k4a_capture_t *capture_handle);

        _k4a_capture_create = self.k4a_dll.k4a_capture_create
    ...
    def k4a_capture_get_depth_image(self, capture_handle):
        #K4A_EXPORT k4a_image_t k4a_capture_get_depth_image(k4a_capture_t capture_handle);

        _k4a_capture_get_depth_image = self.k4a_dll.k4a_capture_get_depth_image
    ...
    def k4a_capture_get_ir_image(self, capture_handle):
        #K4A_EXPORT k4a_image_t k4a_capture_get_ir_image(k4a_capture_t capture_handle);

        _k4a_capture_get_ir_image = self.k4a_dll.k4a_capture_get_ir_image
    ...
    def k4a_capture_set_color_image(self, capture_handle, image_handle):
        #K4A_EXPORT void k4a_capture_set_color_image(k4a_capture_t capture_handle, k4a_image_t image_handle);

        _k4a_capture_set_color_image = self.k4a_dll.k4a_capture_set_color_image
    ...
    def k4a_capture_set_depth_image(self, capture_handle, image_handle):
        #K4A_EXPORT void k4a_capture_set_depth_image(k4a_capture_t capture_handle, k4a_image_t image_handle);

        _k4a_capture_set_depth_image = self.k4a_dll.k4a_capture_set_depth_image
    ...
    def k4a_capture_set_ir_image(self, capture_handle, image_handle):
        #K4A_EXPORT void k4a_capture_set_ir_image(k4a_capture_t capture_handle, k4a_image_t image_handle);

        _k4a_capture_set_ir_image = self.k4a_dll.k4a_capture_set_ir_image
    ...
    def k4a_capture_set_temperature_c(self, capture_handle, temperature):
        #K4A_EXPORT void k4a_capture_set_temperature_c(k4a_capture_t capture_handle, float temperature_c);

        _k4a_capture_set_temperature_c = self.k4a_dll.k4a_capture_set_temperature_c
    ...
    def k4a_capture_get_temperature_c(self, capture_handle):
        #K4A_EXPORT float k4a_capture_get_temperature_c(k4a_capture_t capture_handle);

        _k4a_capture_get_temperature_c = self.k4a_dll.k4a_capture_get_temperature_c
    ...
    def k4a_image_create(self, image_format, width, height, stride, image_handle):
        """
        ...
        """
        _k4a_image_create = self.k4a_dll.k4a_image_create
    ...
    def k4a_image_create_from_buffer(self, image_format, width, height, stride, buffer, buffer_size, buffer_release_cb, buffer_release_cb_context, image_handle):
        """
            K4A_EXPORT k4a_result_t k4a_image_create_from_buffer(k4a_image_format_t format,
                                                                    ...
                                                                    k4a_image_t *image_handle);
        """
        _k4a_image_create_from_buffer = self.k4a_dll.k4a_image_create_from_buffer
    ...
    def k4a_image_get_buffer(self, image_handle):
        #K4A_EXPORT uint8_t *k4a_image_get_buffer(k4a_image_t image_handle);
        
        _k4a_image_get_buffer = self.k4a_dll.k4a_image_get_buffer
    ...
    def k4a_image_get_size(self, image_handle):
        #K4A_EXPORT size_t k4a_image_get_size(k4a_image_t image_handle);

        _k4a_image_get_size = self.k4a_dll.k4a_image_get_size
    ...
    def k4a_image_get_format(self, image_handle):
        #K4A_EXPORT k4a_image_format_t k4a_image_get_format(k4a_image_t image_handle);

        _k4a_image_get_format = self.k4a_dll.k4a_image_get_format
    ...
    def k4a_image_get_width_pixels(self, image_handle):
        #K4A_EXPORT int k4a_image_get_width_pixels(k4a_image_t image_handle);

        _k4a_image_get_width_pixels = self.k4a_dll.k4a_image_get_width_pixels
    ...
    def k4a_image_get_height_pixels(self, image_handle):
        #K4A_EXPORT int k4a_image_get_height_pixels(k4a_image_t image_handle);

        _k4a_image_get_height_pixels = self.k4a_dll.k4a_image_get_height_pixels
    ...
    def k4a_image_get_stride_bytes(self, image_handle):
        #K4A_EXPORT int k4a_image_get_stride_bytes(k4a_image_t image_handle);

        _k4a_image_get_stride_bytes = self.k4a_dll.k4a_image_get_stride_bytes
    ...
    def k4a_image_get_timestamp_usec(self, image_handle):
        #K4A_DEPRECATED_EXPORT uint64_t k4a_image_get_timestamp_usec(k4a_image_t image_handle);

        _k4a_image_get_timestamp_usec = self.k4a_dll.k4a_image_get_timestamp_usec
    ...
    def k4a_image_get_device_timestamp_usec(self, image_handle):
        #K4A_EXPORT uint64_t k4a_image_get_device_timestamp_usec(k4a_image_t image_handle);

        _k4a_image_get_device_timestamp_usec = self.k4a_dll.k4a_image_get_device_timestamp_usec
    ...
    def k4a_image_get_system_timestamp_nsec(self, image_handle):
        #K4A_EXPORT uint64_t k4a_image_get_system_timestamp_nsec(k4a_image_t image_handle);

        _k4a_image_get_system_timestamp_nsec = self.k4a_dll.k4a_image_get_system_timestamp_nsec
    ...
    def k4a_image_get_exposure_usec(self, image_handle):
        #K4A_EXPORT uint64_t k4a_image_get_exposure_usec(k4a_image_t image_handle);

        _k4a_image_get_exposure_usec = self.k4a_dll.k4a_image_get_exposure_usec
    ...
    def k4a_image_get_white_balance(self, image_handle):
        #K4A_EXPORT uint32_t k4a_image_get_white_balance(k4a_image_t image_handle);

        _k4a_image_get_white_balance = self.k4a_dll.k4a_image_get_white_balance
    ...
    def k4a_image_get_iso_speed(self, image_handle):
        #K4A_EXPORT uint32_t k4a_image_get_iso_speed(k4a_image_t image_handle);

        _k4a_image_get_iso_speed = self.k4a_dll.k4a_image_get_iso_speed
    ...
    def k4a_image_set_device_timestamp_usec(self, image_handle, timestamp_usec):
        #K4A_EXPORT void k4a_image_set_device_timestamp_usec(k4a_image_t image_handle, uint64_t timestamp_usec);

        _k4a_image_set_device_timestamp_usec = self.k4a_dll.k4a_image_set_device_timestamp_usec
    ...
    def k4a_image_set_timestamp_usec(self, image_handle, timestamp_usec):
        #K4A_DEPRECATED_EXPORT void k4a_image_set_timestamp_usec(k4a_image_t image_handle, uint64_t timestamp_usec);

        _k4a_image_set_timestamp_usec = self.k4a_dll.k4a_image_set_timestamp_usec
    ...
    def k4a_image_set_system_timestamp_nsec(self, image_handle, timestamp_nsec):
        #K4A_EXPORT void k4a_image_set_system_timestamp_nsec(k4a_image_t image_handle, uint64_t timestamp_nsec);

        _k4a_image_set_system_timestamp_nsec = self.k4a_dll.k4a_image_set_system_timestamp_nsec
    ...
    def k4a_image_set_exposure_usec(self, image_handle, exposure_usec):
        #K4A_EXPORT void k4a_image_set_exposure_usec(k4a_image_t image_handle, uint64_t exposure_usec);

        _k4a_image_set_exposure_usec = self.k4a_dll.k4a_image_set_exposure_usec
    ...
    def k4a_image_set_exposure_time_usec(self, image_handle, exposure_usec):
        #K4A_DEPRECATED_EXPORT void k4a_image_set_exposure_time_usec(k4a_image_t image_handle, uint64_t exposure_usec);

        _k4a_image_set_exposure_time_usec = self.k4a_dll.k4a_image_set_exposure_time_usec
    ...
    def k4a_image_set_white_balance(self, image_handle, white_balance):
        #K4A_EXPORT void k4a_image_set_white_balance(k4a_image_t image_handle, uint32_t white_balance);

        _k4a_image_set_white_balance = self.k4a_dll.k4a_image_set_white_balance
    ...
    def k4a_image_set_iso_speed(self, image_handle, iso_speed):
        #K4A_EXPORT void k4a_image_set_iso_speed(k4a_image_t image_handle, uint32_t iso_speed);

        _k4a_image_set_iso_speed = self.k4a_dll.k4a_image_set_iso_speed
    ...
    def k4a_device_stop_cameras(self, device_handle):
        #K4A_EXPORT void k4a_device_stop_cameras(k4a_device_t device_handle);

        _k4a_device_stop_cameras = self.k4a_dll.k4a_device_stop_cameras
    ...
    def k4a_device_start_imu(self, device_handle):
        #K4A_EXPORT k4a_result_t k4a_device_start_imu(k4a_device_t device_handle);

        _k4a_device_start_imu = self.k4a_dll.k4a_device_start_imu
    ...
    def k4a_device_stop_imu(self, device_handle):
        #K4A_EXPORT void k4a_device_stop_imu(k4a_device_t device_handle);

        _k4a_device_stop_imu = self.k4a_dll.k4a_device_stop_imu
        _k4a_device_stop_imu.restype=None
        _k4a_device_stop_imu.argtypes=(k4a_device_t,)

        _k4a_device_stop_imu(device_handle)
        
    def k4a_device_get_serialnum(self, device_handle, serial_number, serial_number_size):
        """
        ...
        _k4a_device_get_serialnum = self.k4a_dll.k4a_device_get_serialnum
    ...
    def k4a_device_get_version(self, device_handle, hardware_version):
        #K4A_EXPORT k4a_result_t k4a_device_get_version(k4a_device_t device_handle, k4a_hardware_version_t *version);

        _k4a_device_get_version = self.k4a_dll.k4a_device_get_version
    ...
    def k4a_device_get_color_control_capabilities(self, device_handle, command, supports_auto, min_value, max_value, step_value, default_value, default_mode):
        """
        ...
        _k4a_device_get_color_control_capabilities = self.k4a_dll.k4a_device_get_color_control_capabilities
    ...
    def k4a_device_get_color_control(self, device_handle, command, mode, value):
        """
        ...
        _k4a_device_get_color_control = self.k4a_dll.k4a_device_get_color_control
    ...
    def k4a_device_set_color_control(self, device_handle, command, mode, value):
        """
        ...
        _k4a_device_set_color_control = self.k4a_dll.k4a_device_set_color_control
    ...
    def k4a_device_get_raw_calibration(self, device_handle, data, data_size):
        """
        ...
        _k4a_device_get_raw_calibration = self.k4a_dll.k4a_device_get_raw_calibration
    ...
    def k4a_device_get_calibration(self, device_handle, depth_mode, color_resolution, calibration):
        """
        ...
        _k4a_device_get_calibration = self.k4a_dll.k4a_device_get_calibration
    ...
    def k4a_device_get_sync_jack(self, device_handle, sync_in_jack_connected, sync_out_jack_connected):
        """
        ...
        _k4a_device_get_sync_jack = self.k4a_dll.k4a_device_get_sync_jack
    ...
    def k4a_calibration_get_from_raw(self, raw_calibration, raw_calibration_size, depth_mode, color_resolution, calibration):
        """
        ...
        _k4a_calibration_get_from_raw = self.k4a_dll.k4a_calibration_get_from_raw
    ...
    def k4a_calibration_3d_to_3d(self, calibration, source_point3d_mm, source_camera, target_camera, target_point3d_mm):
        """
        ...
        _k4a_calibration_3d_to_3d = self.k4a_dll.k4a_calibration_3d_to_3d
    ...
    def k4a_calibration_2d_to_3d(self, calibration, source_point2d, source_depth_mm, source_camera, target_camera, target_point3d_mm, valid):
        """
        ...
        _k4a_calibration_2d_to_3d = self.k4a_dll.k4a_calibration_2d_to_3d
    ...
    def k4a_calibration_3d_to_2d(self, calibration, source_point3d_mm, source_camera, target_camera, target_point2d, valid):
        """
        ...
        _k4a_calibration_3d_to_2d = self.k4a_dll.k4a_calibration_3d_to_2d
    ...
    def k4a_calibration_2d_to_2d(self, calibration, source_point2d, source_depth_mm, source_camera, target_camera, target_point2d, valid):
        """
        ...
        _k4a_calibration_2d_to_2d = self.k4a_dll.k4a_calibration_2d_to_2d
    ...
    def k4a_calibration_color_2d_to_depth_2d(self, calibration, source_point2d, depth_image, target_point2d, valid):
        """
        ...
        _k4a_calibration_color_2d_to_depth_2d = self.k4a_dll.k4a_calibration_color_2d_to_depth_2d
    ...
    def k4a_transformation_create(self, calibration):
        #K4A_EXPORT k4a_transformation_t k4a_transformation_create(const k4a_calibration_t *calibration);

        _k4a_transformation_create = self.k4a_dll.k4a_transformation_create
    ...
    def k4a_transformation_destroy(self, transformation_handle):
        #K4A_EXPORT void k4a_transformation_destroy(k4a_transformation_t transformation_handle);

        _k4a_transformation_destroy = self.k4a_dll.k4a_transformation_destroy
    ...
    def k4a_transformation_depth_image_to_color_camera(self, transformation_handle, depth_image, transformed_depth_image):
        """
        ...
        _k4a_transformation_depth_image_to_color_camera = self.k4a_dll.k4a_transformation_depth_image_to_color_camera
    ...
    def k4a_transformation_depth_image_to_color_camera_custom(self, transformation_handle, depth_image, custom_image, transformed_depth_image, transformed_custom_image, interpolation_type, invalid_custom_value):
        """
        ...
        _k4a_transformation_depth_image_to_color_camera_custom = self.k4a_dll.k4a_transformation_depth_image_to_color_camera_custom
    ...
    def k4a_transformation_color_image_to_depth_camera(self, transformation_handle, depth_image, color_image, transformed_color_image):
        """
        ...
        _k4a_transformation_color_image_to_depth_camera = self.k4a_dll.k4a_transformation_color_image_to_depth_camera
    ...
    def k4a_transformation_depth_image_to_point_cloud(self, transformation_handle, depth_image, camera, xyz_image):
        """
        ...
        _k4a_transformation_depth_image_to_point_cloud = self.k4a_dll.k4a_transformation_depth_image_to_point_cloud
